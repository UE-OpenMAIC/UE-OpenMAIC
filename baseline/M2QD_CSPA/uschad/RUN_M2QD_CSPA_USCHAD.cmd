...
set "RUN_ENTRY=%DATASET_DIR%run_m2qd_cspa_uschad.py"
set "CONFIG_TXT=%DATASET_DIR%uschad_config.txt"
set "OUT_DIR=%DATASET_DIR%results_m2qd_cspa_uschad"
...
echo.
echo ============================================================
echo [4/4] Starting real USC-HAD M2QD_CSPA run
echo ============================================================
echo.
