...
set "RUN_ENTRY=%DATASET_DIR%run_m2qd_cspa_actrectut.py"
set "CONFIG_TXT=%DATASET_DIR%actrectut_config.txt"
set "OUT_DIR=%DATASET_DIR%results_m2qd_cspa_actrectut"
...
echo.
echo ============================================================
echo [4/4] Starting real ActRecTut M2QD_CSPA run
echo ============================================================
echo.
