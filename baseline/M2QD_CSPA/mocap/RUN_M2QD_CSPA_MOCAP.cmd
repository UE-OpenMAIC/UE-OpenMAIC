...
set "RUN_ENTRY=%DATASET_DIR%run_m2qd_cspa_mocap.py"
set "CONFIG_TXT=%DATASET_DIR%mocap_config.txt"
set "OUT_DIR=%DATASET_DIR%results_m2qd_cspa_mocap"
...
echo.
echo ============================================================
echo [4/4] Starting real MoCap M2QD_CSPA run
echo ============================================================
echo.
