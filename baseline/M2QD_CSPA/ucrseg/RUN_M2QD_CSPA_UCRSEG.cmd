...
set "RUN_ENTRY=%DATASET_DIR%run_m2qd_cspa_ucrseg.py"
set "CONFIG_TXT=%DATASET_DIR%ucrseg_config.txt"
set "OUT_DIR=%DATASET_DIR%results_m2qd_cspa_ucrseg"
...
echo.
echo ============================================================
echo [4/4] Starting real UCR-SEG M2QD_CSPA run
echo ============================================================
echo.
