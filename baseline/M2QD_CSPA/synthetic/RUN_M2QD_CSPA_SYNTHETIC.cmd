...
set "RUN_ENTRY=%DATASET_DIR%run_m2qd_cspa_synthetic.py"
set "CONFIG_TXT=%DATASET_DIR%synthetic_config.txt"
set "OUT_DIR=%DATASET_DIR%results_m2qd_cspa_synthetic"
...
echo.
echo ============================================================
echo [4/4] Starting real Synthetic M2QD_CSPA run
echo ============================================================
echo.
