...
set "RUN_ENTRY=%DATASET_DIR%run_ec_tdwm_actrectut.py"
set "CONFIG_TXT=%DATASET_DIR%actrectut_config.txt"
set "OUT_DIR=%DATASET_DIR%results_ec_tdwm_actrectut"
...
echo.
echo ============================================================
echo [4/4] Starting real ActRecTut EC_TDWM run
echo ============================================================
echo.
