...
set "RUN_ENTRY=%DATASET_DIR%run_ec_tdwm_PAMAP2_zero.py"
set "CONFIG_TXT=%DATASET_DIR%pamap2_zero_config.txt"
set "OUT_DIR=%DATASET_DIR%results_ec_tdwm_pamap2_zero"
...
echo.
echo ============================================================
echo [4/4] Starting real PAMAP2_zero EC_TDWM run
echo ============================================================
echo.
