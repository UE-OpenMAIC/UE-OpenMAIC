...
set "RUN_ENTRY=%DATASET_DIR%run_ec_tdwm_mocap.py"
set "CONFIG_TXT=%DATASET_DIR%mocap_config.txt"
set "OUT_DIR=%DATASET_DIR%results_ec_tdwm_mocap"
...
echo.
echo ============================================================
echo [4/4] Starting real MoCap EC_TDWM run
echo ============================================================
echo.
