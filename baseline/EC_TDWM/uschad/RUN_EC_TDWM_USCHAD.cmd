...
set "RUN_ENTRY=%DATASET_DIR%run_ec_tdwm_uschad.py"
set "CONFIG_TXT=%DATASET_DIR%uschad_config.txt"
set "OUT_DIR=%DATASET_DIR%results_ec_tdwm_uschad"
...
echo.
echo ============================================================
echo [4/4] Starting real USC-HAD EC_TDWM run
echo ============================================================
echo.
