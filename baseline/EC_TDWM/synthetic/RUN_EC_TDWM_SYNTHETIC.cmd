...
set "RUN_ENTRY=%DATASET_DIR%run_ec_tdwm_synthetic.py"
set "CONFIG_TXT=%DATASET_DIR%synthetic_config.txt"
set "OUT_DIR=%DATASET_DIR%results_ec_tdwm_synthetic"
...
echo.
echo ============================================================
echo [4/4] Starting real Synthetic EC_TDWM run
echo ============================================================
echo.
