...
set "ENTRY=%METHOD_DIR%\run_e2usd_uschad.py"
set "CONFIG=%METHOD_DIR%\uschad_config.txt"
echo ============================================================
echo E2USD STRICT-FIXED baseline - USCHAD
...
echo.
echo [3/3] Running E2USD strict-fixed USCHAD...
echo ============================================================
...
echo %METHOD_DIR%\results_e2usd_uschad_strict_fixed
:END_PAUSE
echo.
