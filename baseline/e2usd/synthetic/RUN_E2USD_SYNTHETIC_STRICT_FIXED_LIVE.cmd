...
set "ENTRY=%METHOD_DIR%\run_e2usd_synthetic.py"
set "CONFIG=%METHOD_DIR%\synthetic_config.txt"
echo ============================================================
echo E2USD STRICT-FIXED baseline - SYNTHETIC
...
echo.
echo [3/3] Running E2USD strict-fixed SYNTHETIC...
echo ============================================================
...
echo %METHOD_DIR%\results_e2usd_synthetic_strict_fixed
:END_PAUSE
echo.
