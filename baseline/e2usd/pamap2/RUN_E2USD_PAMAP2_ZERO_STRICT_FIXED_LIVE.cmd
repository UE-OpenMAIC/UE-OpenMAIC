...
set "PY_EXE=D:\conda_envs\multit2s_cuda\python.exe"
set "ENTRY=%METHOD_DIR%\run_e2usd_pamap2_zero.py"
set "CONFIG=%METHOD_DIR%\pamap2_zero_config.txt"
echo ============================================================
echo E2USD STRICT-FIXED baseline - PAMAP2_ZERO
...
echo.
echo [3/3] Running E2USD strict-fixed PAMAP2_ZERO...
echo ============================================================
...
echo %METHOD_DIR%\results_e2usd_pamap2_zero_strict_fixed
:END_PAUSE
echo.
