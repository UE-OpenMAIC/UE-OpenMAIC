...
set "ENTRY=%METHOD_DIR%\run_e2usd_actrectut.py"
set "CONFIG=%METHOD_DIR%\actrectut_config.txt"
echo ============================================================
echo E2USD STRICT-FIXED baseline - ACTRECTUT
...
echo.
echo [3/3] Running E2USD strict-fixed ACTRECTUT...
echo ============================================================
...
echo %METHOD_DIR%\results_e2usd_actrectut_strict_fixed
:END_PAUSE
echo.
