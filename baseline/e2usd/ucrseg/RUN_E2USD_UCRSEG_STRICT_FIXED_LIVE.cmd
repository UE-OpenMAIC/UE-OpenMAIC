...
set "ENTRY=%METHOD_DIR%\run_e2usd_ucrseg.py"
set "CONFIG=%METHOD_DIR%\ucrseg_config.txt"
echo ============================================================
echo E2USD STRICT-FIXED baseline - UCRSEG
...
echo.
echo [3/3] Running E2USD strict-fixed UCRSEG...
echo ============================================================
...
echo %METHOD_DIR%\results_e2usd_ucrseg_strict_fixed
:END_PAUSE
echo.
