...
if /I not "%~1"=="__inner__" (
    start "AutoPlait UCRSEG strict baseline - DIRECT PRINT" cmd /k ""%~f0" __inner__"
    exit /b 0
)
set "SCRIPT_DIR=%~dp0"
for %%I in ("%SCRIPT_DIR%..") do set "AUTOPLAIT_ROOT=%%~fI"
set "SHARD_DIR=%AUTOPLAIT_ROOT%\_shard"
set "CONFIG=%SCRIPT_DIR%ucrseg_autoplait_config.txt"
set "CONDA_ENV=multit2s_cuda"
echo ============================================================
echo AutoPlait UCRSEG strict baseline - DIRECT PRINT
