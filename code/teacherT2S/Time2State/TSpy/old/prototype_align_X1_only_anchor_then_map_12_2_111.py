...
OUT_DIR_DEFAULT = T2S_ROOT_DEFAULT / "_cross_video_prototype_alignment_X1_only_anchor_k5_map_12_2_111_111"
...
def main():
    ...
    ap.add_argument("--target-video-ids", type=str, default="12,2,111",

                    help="后验映射目标视频。默认 12,2,111；其中 2 会匹配 2/02。")
    ...
    print("X1-only anchor clustering + posterior mapping: targets 12 + 2 + 111")
