...
title TSSB2 CLaP PID Meta 9x3

set "SCRIPT_DIR=%~dp0"
for %%I in ("%SCRIPT_DIR%..\..") do set "REPO_ROOT=%%~fI"

set "CONFIG=%SCRIPT_DIR%tssb2_clap_pid_meta_9x3_config.txt"
...
echo ============================================================
echo Running TSSB2 CLaP PID-Meta 9x3
...
echo.
echo [3/3] Starting TSSB2 CLaP PID-Meta 9x3
if "%DRYRUN%"=="1" (
...
if not "%RUN_RC%"=="0" (
    echo [ERROR] TSSB2 CLaP PID-Meta 9x3 failed. Exit code=%RUN_RC%
    pause
    exit /b %RUN_RC%
)
