...
title UTSA CLaP PID-Meta 9x3

set "SCRIPT_DIR=%~dp0"
for %%I in ("%SCRIPT_DIR%..\..") do set "REPO_ROOT=%%~fI"
set "CONFIG=%SCRIPT_DIR%utsa2_clap_pid_meta_9x3_config.txt"
set "ENTRY=%SCRIPT_DIR%run_utsa2_clap_pid_meta_9x3.py"
...
echo ============================================================
echo Running UTSA CLaP PID-Meta 9x3
...
echo.
echo [3/3] Starting UTSA CLaP PID-Meta 9x3
if "%DRY_RUN%"=="1" (
...
if not "%RUN_RC%"=="0" (
    echo [ERROR] UTSA CLaP PID-Meta failed. Exit code=%RUN_RC%
    pause
    exit /b %RUN_RC%
)
