...
set "SCRIPT=%METHOD_DIR%\run_pid_ablation_synthetic.py"
set "BASE_CONFIG=%METHOD_DIR%\synthetic_config.txt"
set "ENTRY=%METHOD_DIR%\run_our_synthetic.py"
...
echo ============================================================
echo PID ablation for Synthetic
...
echo.
echo [RUN] Starting PID ablation for Synthetic...
