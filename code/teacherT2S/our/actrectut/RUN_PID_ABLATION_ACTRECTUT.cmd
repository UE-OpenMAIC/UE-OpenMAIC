...
set "SCRIPT=%METHOD_DIR%\run_pid_ablation_actrectut.py"
set "BASE_CONFIG=%METHOD_DIR%\actrectut_config.txt"
set "ENTRY=%METHOD_DIR%\run_our_actrectut.py"
...
echo ============================================================
echo PID ablation for ActRecTut
...
echo.
echo [RUN] Starting PID ablation for ActRecTut...
