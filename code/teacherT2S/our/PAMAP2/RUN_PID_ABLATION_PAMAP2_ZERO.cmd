...
set "SCRIPT=%METHOD_DIR%\run_pid_ablation_pamap2_zero.py"
set "BASE_CONFIG=%METHOD_DIR%\pamap2_zero_config.txt"
set "ENTRY=%METHOD_DIR%\run_our_pamap2_zero.py"
...
set "EXTRA_ARGS="
if /I "%MODE%"=="quick" (
    set "EXTRA_ARGS=--max-series 1 --only-case-ids 101"
)
...
echo ============================================================
echo PID ablation for PAMAP2_zero
...
echo.
echo [RUN] Starting PID ablation for PAMAP2_zero...
