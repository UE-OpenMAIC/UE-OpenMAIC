...
- If the slide contains a video element, generate exactly this structure: one short transition speech first, then `play_video` immediately after it. Do not add spotlight/laser or extra speech before/after the video.
