...
export interface VideoGenerationOptions {
  ...
  /** Whether the provider should synthesize an audio track for the video */
...
export interface MediaGenerationRequest {
  ...
  style?: string;
  /** Desired video duration in seconds (video only) */
  duration?: number;
  /** Desired output resolution (video only) */
  resolution?: '480p' | '720p' | '1080p';
  /** Request an AI-generated audio track for generated videos */
  generateAudio?: boolean;
}
