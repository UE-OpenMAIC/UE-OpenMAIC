...
interface RoundtableProps {
  ...
  readonly onRegenerateScene?: () => void | Promise<void>;
  readonly regeneratingScene?: boolean;
...
export function Roundtable({
  ...
  return (
    <div
      className={cn(
        'h-[132px] w-full flex flex-col relative z-10 transition-all duration-300',
                ...
                >
                  ...
                  >
                    <div
                      ...
                      className={cn(
                        'relative px-4 pt-1.5 pb-2 rounded-2xl text-[15px] leading-relaxed transition-all border w-[min(1280px,calc(100%-0.75rem))] group/bubble flex flex-col max-h-[84px]',
                          ...
                          return (
                            <div
                              className={cn(
                                ...
                                bubbleRole === 'teacher' ? 'left-2' : '-right-2.5',
                              )}
                              title={bubbleName}
                            >
                              <div
